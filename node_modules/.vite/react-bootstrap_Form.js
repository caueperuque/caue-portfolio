import {
  ...
  FormContext_default,
  FormGroup_default
} from "./chunk-T3LMUFL6.js";
import {
  require_prop_types
} from "./chunk-O5RXLMPQ.js";
import {
  createWithBsPrefix
...
var FormCheckInput = React2.forwardRef((_a, ref) => {
  var _b = _a, {
    id,
    bsPrefix,
    className,
...
var FormCheckLabel = React3.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    className,
    htmlFor
...
var FormCheck = React5.forwardRef((_a, ref) => {
  var _b = _a, {
    id,
    bsPrefix,
    bsSwitchPrefix,
...
var Col = React7.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime8.jsx)(Component, __spreadProps(__spreadValues({}, colProps), {
    ref,
...
var FormLabel = React8.forwardRef((_a, ref) => {
  var _b = _a, {
    as: Component = "label",
    bsPrefix,
    column,
...
var FormRange = React9.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    className,
    id
  ...
  return (0, import_jsx_runtime10.jsx)("input", __spreadProps(__spreadValues({}, props), {
    type: "range",
    ref,
...
var FormSelect = React10.forwardRef((_a, ref) => {
  ...
  return (0, import_jsx_runtime11.jsx)("select", __spreadProps(__spreadValues({}, props), {
    size: htmlSize,
    ref,
...
var FormText = React11.forwardRef((_a, ref) => {
  ...
  return (0, import_jsx_runtime12.jsx)(Component, __spreadProps(__spreadValues({}, props), {
    ref,
...
var Switch = React12.forwardRef((props, ref) => (0, import_jsx_runtime13.jsx)(FormCheck_default, __spreadProps(__spreadValues({}, props), {
  ref,
  type: "switch"
})));
...
var Form = React13.forwardRef((_a, ref) => {
  var _b = _a, {
    className,
    validated,
    as: Component = "form"
