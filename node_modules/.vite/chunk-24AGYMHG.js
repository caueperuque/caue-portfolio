...
var Fade = React4.forwardRef((_a, ref) => {
  var _b = _a, {
    className,
    children,
    transitionClasses = {}
  ...
  return (0, import_jsx_runtime2.jsx)(TransitionWrapper_default, __spreadProps(__spreadValues({
    ...
    children: (status, innerProps) => React4.cloneElement(children, __spreadProps(__spreadValues({}, innerProps), {
...
var CloseButton = React5.forwardRef((_a, ref) => {
  var _b = _a, {
    className,
    variant
  } = _b, props = __objRest(_b, [
  ...
  return (0, import_jsx_runtime3.jsx)("button", __spreadValues({
    ref,
    type: "button",
...
var divWithClassName_default = (className) => React6.forwardRef((p, ref) => (0, import_jsx_runtime4.jsx)("div", __spreadProps(__spreadValues({}, p), {
  ref,
...
//# sourceMappingURL=chunk-24AGYMHG.js.map
